    ...
    homeSectionArr: [
      {
        ...
        Through this application, students can provide feedback regarding the university, enabling sentiment analysis to be performed on their responses.`,
          // , allowing for targeted areas of improvement to be identified and addressed.
        ],
      },
      {
    ...
    aboutSectionArr: [
      {
        title: "PROJECT CONTEXT",
        paragraphsArr: [
          `Due to the COVID-19 pandemic, institutions had to adopt the online mode of learning resulting in them being more active in getting feedback from students since these can be used as a basis of improvement. However, as we emerge from the pandemic and move towards more face-to-face learning, analyzing student feedback remains essential to further understand how students feel and get recommendations for improvement.`,
          `To address this gap, the researchers proposed to develop a web-based feedback system that will gather student responses and perform sentiment analysis in order to evaluate student sentiments and get recommendations from them.`,
        ],
      },
    ],
